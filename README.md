...
4. Finally, **highlighting clusters** in images can **interfere** with the model's learning. Pre-clustered images may inaccurately convey the general characteristics of classes. The model demonstrated better results without cluster allocation. (**not sure**)
